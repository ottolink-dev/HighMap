...
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ glm::ivec2\ shape\ =\ \{512,\ 256\};}
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Header   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
array.\+hpp   &Declaration of the Array class for 2D floating-\/point arrays with various mathematical operations and utilities.   \\\cline{1-2}
\end{longtabu}
