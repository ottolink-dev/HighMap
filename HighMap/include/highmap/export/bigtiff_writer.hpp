...
/**
 * @file bigtiff_writer.hpp
 * @author Otto Link (otto.link.bv@gmail.com)
 * @brief BigTIFF tiled image writer implementing ImageWriter interface.
 *
...
class BigTiffWriter : public ImageWriter
{
public:
  BigTiffWriter();
  explicit BigTiffWriter(const std::string       &filepath,
                         const ImageWriterConfig &config);
  ~BigTiffWriter() override;
